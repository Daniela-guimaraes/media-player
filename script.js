...
let repeatOn = false;
const originalPlaylist = JSON.parse(localStorage.getItem('playlist')) ?? [song1, song2, song3, song4];
...
function initializeSong() {
    cover.src = `images/${sortedPlaylist[index].cover}`;
    song.src = `songs/${sortedPlaylist[index].song}`;
